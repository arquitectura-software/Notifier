...
var router = (0, _express.Router)(); //Database conecction
...
function () {
  ...
  regeneratorRuntime.mark(function _callee2(req, res) {
    var db, notificationData, result;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            _context2.next = 6;
            return db.collection("notifications").insertOne(notificationData);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            db = _context3.sent;
            _context3.next = 6;
            return db.collection("notifications").findOne({
